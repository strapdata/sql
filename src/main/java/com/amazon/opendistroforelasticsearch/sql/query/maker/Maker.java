...
import com.amazon.opendistroforelasticsearch.sql.spatial.BoundingBoxFilterParams;
import com.amazon.opendistroforelasticsearch.sql.spatial.DistanceFilterParams;
...
import static com.amazon.opendistroforelasticsearch.sql.parser.WhereParser.getConditionForMethod;
...
public abstract class Maker {
    ...
    private static final Set<Condition.OPEAR> NOT_OPEAR_SET = ImmutableSet.of(
            Condition.OPEAR.N, Condition.OPEAR.NIN, Condition.OPEAR.ISN, Condition.OPEAR.NBETWEEN, Condition.OPEAR.NLIKE, Condition.OPEAR.NIN_TERMS, Condition.OPEAR.NTERM
    );
